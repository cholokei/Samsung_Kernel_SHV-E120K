...
#else
static int diagfwd_delay_done = 1;
#endif
static void diagfwd_delay_work_fn(struct delayed_work *work);
			...
			struct diag_request *d_req)
{
	...
	case USB_DIAG_CONNECT:
		if (diagfwd_delay_done)
			...
			schedule_delayed_work(&diagfwd_delay_work, msecs_to_jiffies(5000));		
		break;
